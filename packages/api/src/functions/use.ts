...
const getFunctions = <TDocument extends Document<OptionalId<any>>>() => ({
...
export const useFunctions = <TDocument extends Document<OptionalId<any>>>() => <TSelectedFunctions extends Array<keyof typeof collFunctions>>(
